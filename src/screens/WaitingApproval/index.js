...
const WaitApproval = ({ navigation, route }) => {
      ...
      switch (distination) {
         ...
         case LATE_EXCUTION:
            return (
               ...
               data?.spareParts.every(item => item.checked) && (
                  <CustomButton
            ...
            if (userType != AMANA_USER)
               return (
                  <CustomButton
                     buttonContainerStyle={{ ...styles.button, width: '90%' }}
                     buttonTitle={'تعميد'}
                     onButtonPressed={handleAcceptPerview}
   ...
   const onCheckItem = (index, Id) => {
      data.spareParts[index]['checked'] = !data.spareParts[index]['checked'];
      setreRenderSpareList(!reRenderSpareList);
   };
   return (
      <ImageBackground
            ...
            <>
               ...
               <View style={styles.bottomSheetContainer}>
                  <CustomBottomSheet
                     ...
                     userName={userName}
                     onCheckItem={(index, Id) => onCheckItem(index, Id)}
                  />
               </View>
